...
library(igraph)
file="C:/Users/Vitor/Desktop/sim/g_dynSocEdges_tam_15_ags_100_raio_2_eps_3_mPts_4_nTurnos_2000_tMem_9_rep_4.txt"

data=as.data.frame(read.table(file, as.is=T, header= F, sep=";", skip=1))
